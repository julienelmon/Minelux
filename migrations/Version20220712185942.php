 ...
 */
final class Version20220712185942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE text text INT NOT NULL, CHANGE to_user_id to_user INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE text text LONGTEXT NOT NULL, CHANGE to_user to_user_id INT NOT NULL');
    }
}
